...
Events.onAddForageDefs.Add(function()
    ...
    local AppleSeed = {
        ...
        local CommonMallowSeeds = {
            type = "Sprout.CommonMallowSeeds",
            minCount = 1,
            maxCount = 6,
            skill = 4,
            xp = 5,
        ...
        local BlackSageSeeds = {
            type = "Sprout.BlackSageSeeds",
            minCount = 1,
            maxCount = 6,
            skill = 4,
            xp = 5,
...
forageSystem.addItemDef(PearSeeds);
forageSystem.addItemDef(CommonMallowSeeds);
forageSystem.addItemDef(PlantainSeeds);
forageSystem.addItemDef(ComfreySeeds);
forageSystem.addItemDef(GarlicSeeds);
forageSystem.addItemDef(BlackSageSeeds);
